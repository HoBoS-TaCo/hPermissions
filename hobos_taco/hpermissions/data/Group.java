...
public class Group
{
	...
	public boolean commandDisabled;
	public String[] perms;
    ...
    public static void createDefaultGroups()
    {
        ...
        defaultG.commandDisabled = false;
        ...
        moderatorG.commandDisabled = true;
        moderatorG.perms = new String[] {"hpermissions.reload", "hpermissions.promote", "hpermissions.set", "hpermissions.demote"};
        ...
        adminG.prefix = "Admin ";
        adminG.suffix = "";
        adminG.commandDisabled = true;
        adminG.prevGroup = "Moderator";
        adminG.perms = new String[] {"hpermissions.reload", "hpermissions.promote", "hpermissions.set", "hpermissions.demote"};
